...
function exportToExcel(selectedRows) {
    let csvContent = "\uFEFF"; 
    csvContent += "ID,اسم المنشأة / الشركة,العنوان,السجل الرئيسي,الشخص المسؤول,رقم التواصل,البريد الإلكتروني,التصنيف,الحالة,تاريخ الإنشاء,المالك\n";
    ...
    let html = `
        ...
        <body>
            ...
            <table>
                <thead>
                    <tr>
                        <th>ID</th><th>الشركة</th><th>المسؤول</th><th>رقم التواصل</th>
...
// الفلترة محددة بدقة للأعمدة الستة التي طلبتها سابقاً
